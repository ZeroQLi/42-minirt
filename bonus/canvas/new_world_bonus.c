...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/04/05 17:26:21 by nanasser          #+#    #+#             */
/*   Updated: 2026/04/05 17:26:21 by nanasser         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	new_world(t_world *w)
{
	...
	while (l)
	{
		l->light.p_light = point_light(create_point(l->px, l->py, l->pz),
				multiply_colors(color_from_rgb(l->cr, l->cg, l->cb),
					l->emission));
		l = l->next;
	}
	if (w->sp)
